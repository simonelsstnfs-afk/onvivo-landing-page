      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="text-center mb-16 flex flex-col items-center">
          <div className="flex items-center gap-2 mb-4 px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/5 backdrop-blur-md">
            ...
            <span className="text-[10px] md:text-xs font-mono font-bold tracking-[0.2em] text-white/50 uppercase">PAGO ÚNICO // SIN SUSCRIPCIONES</span>
          </div>
          ...
          <p className="text-white/40 max-w-lg text-sm md:text-base leading-relaxed">
            Sin suscripciones mensuales ni costes ocultos. Configura tu servicio una vez y disfrútalo para siempre.
          </p>
        </div>
          ...
          <div className="relative m-[1px] bg-[#07070a]/95 backdrop-blur-2xl rounded-3xl p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              <div className="flex items-baseline justify-center gap-2">
                <span className="text-6xl md:text-7xl font-black text-white tracking-tighter">50</span>
                <div className="text-left">
                  <span className="text-2xl font-bold text-white/80">€</span>
                  <div className="text-[10px] font-mono text-white/30 tracking-widest uppercase">PAGO ÚNICO</div>
                </div>
              </div>
              <p className="text-white/40 text-xs mt-3 font-mono tracking-wider">SIN RENOVACIONES // ACCESO DE POR VIDA</p>
            </div>
            ...
            <div className="space-y-3.5 mb-8">
              {[
                ...
                "Resolución 1080p Full HD optimizada",
                "7 addons premium preinstalados",
                "Acceso multiplataforma (TV, PC, Móvil)",
                "Soporte técnico de activación incluido",
                "Guía de inicio rápido por email",
              ].map((benefit, idx) => (
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full group relative inline-flex items-center justify-center py-4 bg-gradient-to-r from-[#00F0FF] via-[#7000FF] to-[#FF007A] text-white font-mono text-xs font-bold uppercase tracking-[0.2em] rounded-xl overflow-hidden shadow-[0_0_30px_rgba(0,240,255,0.3)] transition-all duration-300 cursor-pointer"
            >
              ...
              <span className="relative z-10 flex items-center gap-2">
                CONFIGURAR MI STREAMING <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
              </span>
            </motion.button>
            ...
            <div className="flex items-center justify-center gap-6 mt-6 pt-6 border-t border-white/5">
              <div className="flex items-center gap-1.5 text-white/30">
                ...
                <span className="text-[9px] font-mono tracking-wider uppercase">Pago Seguro</span>
              </div>
              <div className="flex items-center gap-1.5 text-white/30">
                <Zap className="w-3.5 h-3.5" />
                <span className="text-[9px] font-mono tracking-wider uppercase">Setup Instantáneo</span>
              </div>
              <div className="flex items-center gap-1.5 text-white/30">
                <Clock className="w-3.5 h-3.5" />
                <span className="text-[9px] font-mono tracking-wider uppercase">De por Vida</span>
              </div>
            </div>
          </div>
        </motion.div>
